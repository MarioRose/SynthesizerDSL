...
public class SynthesizerGenerator extends AbstractGenerator {
  ...
  public void doGenerate(final Resource resource, final IFileSystemAccess2 fsa, final IGeneratorContext context) {
    ...
    String _plus_2 = (_plus_1 + _generateUI);
    String _plus_3 = (_plus_2 + "\n\n\t\t    @Override\n\t\t    public void start() {\n\t        \t// Create a context for the synthesizer.\n\t            synth = JSyn.createSynthesizer();\n\t            // Start synthesizer using default stereo output at 44100 Hz.\n\t            synth.start();\n\t            // Add a stereo audio output unit.\n\t            synth.add(lineOut = new LineOut());\n\t            // We only need to start the LineOut. It will pull data from the\n\t            // oscillator.\n\t            lineOut.start();\n\n\t\t\t\t");
    final Function1<SineOscillator, String> _function_1 = (SineOscillator it) -> {
      String _name = it.getName();
      String _plus_4 = ("createSound" + _name);
      return (_plus_4 + "();\t       \n\t\t\t\t");
    };
    String _join_1 = IteratorExtensions.join(IteratorExtensions.<SineOscillator, String>map(Iterators.<SineOscillator>filter(resource.getAllContents(), SineOscillator.class), _function_1), "\n\t\t\t\t");
    ...
    final Function1<SineOscillator, String> _function_2 = (SineOscillator it) -> {
      String _name = it.getName();
      String _plus_6 = ("private static void createSound" + _name);
      String _plus_7 = (_plus_6 + "() {\n\t\t\t\t");
      String _plus_8 = (_plus_7 + 
        "\tosc");
      String _name_1 = it.getName();
      String _plus_9 = (_plus_8 + _name_1);
      String _plus_10 = (_plus_9 + " = new SineOscillator();\n\t\t\t\t\t// Add a tone generator.\n\t\t            synth.add(osc");
      String _name_2 = it.getName();
      String _plus_11 = (_plus_10 + _name_2);
      String _plus_12 = (_plus_11 + " );\n\t\t\t\t\n\t\t            // Set the frequency and amplitude for the sine wave.\n\t\t            osc");
      String _name_3 = it.getName();
      String _plus_13 = (_plus_12 + _name_3);
      String _plus_14 = (_plus_13 + ".frequency.set(");
      int _frequency = it.getFrequency();
      String _plus_15 = (_plus_14 + Integer.valueOf(_frequency));
      String _plus_16 = (_plus_15 + ");\n\t\t            osc");
      String _name_4 = it.getName();
      String _plus_17 = (_plus_16 + _name_4);
      String _plus_18 = (_plus_17 + ".amplitude.set(");
      int _amplitude = it.getAmplitude();
      String _plus_19 = (_plus_18 + Integer.valueOf(_amplitude));
      String _plus_20 = (_plus_19 + ");\n\t\t\t\t}\n\t\t\t\n\t\t\t\tprivate static void playSound");
      String _name_5 = it.getName();
      String _plus_21 = (_plus_20 + _name_5);
      String _plus_22 = (_plus_21 + "(){\n\t\t\t\t\tif(!osc");
      String _name_6 = it.getName();
      String _plus_23 = (_plus_22 + _name_6);
      String _plus_24 = (_plus_23 + ".output.isConnected()) {\n\t\t\t            osc");
      String _name_7 = it.getName();
      String _plus_25 = (_plus_24 + _name_7);
      String _plus_26 = (_plus_25 + ".output.connect(0, lineOut.input, 0);\n\t\t\t            osc");
      String _name_8 = it.getName();
      String _plus_27 = (_plus_26 + _name_8);
      String _plus_28 = (_plus_27 + ".output.connect(0, lineOut.input, 1);\n\t\t\t\t\t}\n\t\t\t\t\telse {\n\t\t\t            osc");
      String _name_9 = it.getName();
      String _plus_29 = (_plus_28 + _name_9);
      String _plus_30 = (_plus_29 + ".output.disconnect(0, lineOut.input, 0);\n\t\t\t            osc");
      String _name_10 = it.getName();
      String _plus_31 = (_plus_30 + _name_10);
      return (_plus_31 + ".output.disconnect(0, lineOut.input, 1);\n\t\t\t\t\t}\n\t\t\t\t}\n\t        ");
    };
    ...
    fsa.generateFile("SynthesizerDSL.java", _plus_7);
  }
