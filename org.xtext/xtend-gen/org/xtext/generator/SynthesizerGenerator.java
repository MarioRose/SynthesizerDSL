...
public class SynthesizerGenerator extends AbstractGenerator {
  ...
  public void doGenerate(final Resource resource, final IFileSystemAccess2 fsa, final IGeneratorContext context) {
    ...
    final Function1<SineOscillator, String> _function_10 = (SineOscillator it) -> {
      ...
      String _plus_26 = (_plus_25 + " = new SineOscillator();\n\t\t\t\t\t// Add a tone generator.\n\t\t            synth.add(osc");
    ...
    final Function1<SawToothOscillator, String> _function_11 = (SawToothOscillator it) -> {
      ...
      String _plus_28 = (_plus_27 + " = new SawtoothOscillator();\n\t\t\t\t\t// Add a tone generator.\n\t\t            synth.add(osc");
      String _name_2 = it.getName();
    ...
    final Function1<TriangleOscillator, String> _function_12 = (TriangleOscillator it) -> {
      ...
      String _plus_30 = (_plus_29 + " = new TriangleOscillator();\n\t\t\t\t\t// Add a tone generator.\n\t\t            synth.add(osc");
      String _name_2 = it.getName();
    ...
    final Function1<SquareOscillator, String> _function_13 = (SquareOscillator it) -> {
      ...
      String _plus_32 = (_plus_31 + " = new SquareOscillator();\n\t\t\t\t\t// Add a tone generator.\n\t\t            synth.add(osc");
      String _name_2 = it.getName();
    ...
    final Function1<PulseOscillator, String> _function_14 = (PulseOscillator it) -> {
      ...
      String _plus_34 = (_plus_33 + " = new PulseOscillator();\n\t\t\t\t\t// Add a tone generator.\n\t\t            synth.add(osc");
      String _name_2 = it.getName();
    ...
    fsa.generateFile("SynthesizerDSL.java", _plus_31);
  }
